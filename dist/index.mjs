class $d0ecb8dcc51d3116$var$Thumb {
...
var $d0ecb8dcc51d3116$export$2e2bcd8739ae039 = $d0ecb8dcc51d3116$var$Thumb;


class $fb6361ef48b7c746$var$Track {
    constructor(container, options){
        this.mouseOnTrack = false;
        // console.log(options)
        this.container = container;
        this.options = options;
        this.thumb = new (0, $d0ecb8dcc51d3116$export$2e2bcd8739ae039)(container, options);
        this.init();
    }
    init() {
        this.element = document.createElement("div");
...
var $fb6361ef48b7c746$export$2e2bcd8739ae039 = $fb6361ef48b7c746$var$Track;


var $7dd91c38e3883378$var$Direction;
(function(Direction) {
    Direction[Direction["VERTICAL"] = 0] = "VERTICAL";
    Direction[Direction["HORIZONTAL"] = 1] = "HORIZONTAL";
})($7dd91c38e3883378$var$Direction || ($7dd91c38e3883378$var$Direction = {}));
var $7dd91c38e3883378$export$2e2bcd8739ae039 = $7dd91c38e3883378$var$Direction;


let $93ac0c9706484ac3$var$dragging = false;
function $93ac0c9706484ac3$export$242d43875ab79ce3(scrollbar) {
    ...
    scrollbar.getElement().addEventListener("mouseleave", ()=>{
        if ($93ac0c9706484ac3$var$dragging) return;
        scrollbar.hide();
    });
    ...
    function mouseDownHandler(e) {
        e.preventDefault();
        $93ac0c9706484ac3$var$dragging = true;
    ...
    function mouseUpHandler(e) {
        e.preventDefault();
        $93ac0c9706484ac3$var$dragging = false;
        document.removeEventListener("mousemove", mouseMoveHandler);
        document.removeEventListener("mouseup", mouseUpHandler);
        if (!mouseOnThumb) scrollbar.hide();
    }
}
function $93ac0c9706484ac3$export$f43482f3c394e174(scrollableDiv, scrollbar) {
    if (scrollableDiv === document.body) {
        ...
        window.addEventListener("scrollend", ()=>{
            if (!$93ac0c9706484ac3$var$dragging) scrollbar.hide();
        });
    } else {
...
class $72ece774bec7bfed$var$Scrollbar {
    constructor(container, options, direction = (0, $7dd91c38e3883378$export$2e2bcd8739ae039).VERTICAL){
        this.options = options;
        if (container !== document.body) {
            this.container = container;
            this.direction = direction;
            this.track = new (0, $fb6361ef48b7c746$export$2e2bcd8739ae039)(container, this.options);
    ...
    init() {
        (0, $93ac0c9706484ac3$export$242d43875ab79ce3)(this);
        setTimeout(()=>{
    ...
    addEventListener() {
        (0, $93ac0c9706484ac3$export$f43482f3c394e174)(this.container, this);
    }
...
var $72ece774bec7bfed$export$2e2bcd8739ae039 = $72ece774bec7bfed$var$Scrollbar;



class $149c1bd638913645$export$843f6040c32573f9 {
    /* 
    ...
    init(element, options) {
        ...
        if (element) {
            ...
            this.scrollbar = new (0, $72ece774bec7bfed$export$2e2bcd8739ae039)(this.scrollableDiv, this.options, (0, $7dd91c38e3883378$export$2e2bcd8739ae039).VERTICAL);
            this.element.appendChild(this.scrollbar.getElement());
        } else {
            this.element = document.body;
            this.scrollbar = new (0, $72ece774bec7bfed$export$2e2bcd8739ae039)(this.element, this.options, (0, $7dd91c38e3883378$export$2e2bcd8739ae039).VERTICAL);
            this.element.appendChild(this.scrollbar.getElement());
        }
        this.injectStyle();
    }
...
export {$149c1bd638913645$export$843f6040c32573f9 as EnchantScrollbar};
